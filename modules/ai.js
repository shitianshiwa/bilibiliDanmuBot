...
const askAi = async (sender, message)=>{
    let {body} = await got.get('https://tbp.cloud.tencent.com/chatflow/demoQuery?Action=TextProcess&AgentId='+
        'vqwd4BbLH%2Bc4J%2BOoqCOgt7qCz6PEcFpNq%2F9p5%2BIH09vhwmGXCiGX1Ro8kireVtL9ZlFTAMP%2Fk%2BZ%2Bz9ZnZrcl6'+
        'fS7QFNKJ2pd84w1oSa6fuQ%3D&SessionId='+sender+'&QueryText='+message,{
        responseType:"json"
    })
